...
namespace CrossMod.GUI
{
    public partial class ModelViewport : UserControl
    {
        ...
        {
            return Framebuffer.ReadDefaultFramebufferImagePixels(glViewport.Width, glViewport.Height, BGSettings.renderAlpha);
        }
        ...
        public async System.Threading.Tasks.Task RenderAnimationToGifAsync(string outputPath, IProgress<int> progress)
        {
            ...
            for (int i = 0; i <= animationBar.FrameCount; i++)
            {
                ...
                frames.Add(Framebuffer.ReadDefaultFramebufferImagePixels(glViewport.Width, glViewport.Height, BGSettings.renderAlpha));
        ...
        private static void ClearViewportBuffers()
        {
            ...
            GL.ClearColor(BGSettings.red, BGSettings.green, BGSettings.blue, 1);
        }
