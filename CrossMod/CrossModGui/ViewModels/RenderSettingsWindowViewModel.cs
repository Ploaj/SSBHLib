...
namespace CrossModGui.ViewModels
{
    public class RenderSettingsWindowViewModel : ViewModelBase
    {
        ...
        private static readonly List<RenderModeItem> renderModeItems = new List<RenderModeItem>
        {
            ...
            new RenderModeItem { Value = RenderSettings.RenderMode.SpecularCube, Description = "Specular Cube (Texture7)", Category = "Textures" },
            ...
            new RenderModeItem { Value = RenderSettings.RenderMode.Normal0, Description = "Normal0", Category = "Vertex Attributes" },
        ...
        public bool EnableBakedLighting { get; set; }
        ...
        public RenderSettingsWindowViewModel(RenderSettings renderSettings)
        {
            ...
            EnableBakedLighting = renderSettings.RenderBakedLighting;
            EnablePostProcessing = renderSettings.EnablePostProcessing;
        ...
        public void SetValues(RenderSettings settings)
        {
            ...
            settings.RenderBakedLighting = EnableBakedLighting;
            settings.EnablePostProcessing = EnablePostProcessing;
